...
# Variant with --use-random-as-key enabled, MARFORMER_FULL_RANDOM=0 (no fresh randomness)
...
RUN_NAME="marformer_random_as_key"  # Leave empty for auto-generated name, or specify custom name
