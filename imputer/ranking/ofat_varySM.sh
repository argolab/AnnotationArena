#!/bin/bash
# OFAT: Vary σ_measurement Experiments Only
...
# Main execution
echo "=============================================="
echo "OFAT: VARY σ_MEASUREMENT EXPERIMENTS"
echo "=============================================="
echo ""
...
echo "  σ_measurement=$BASE_SIGMA_MEASUREMENT (baseline, not run in this script)"
echo "  κ=$BASE_KAPPA"
...
echo "======================================"
echo "OFAT SET: Varying σ_measurement"
echo "======================================"
...
echo ""
echo "=============================================="
echo "OFAT VARY σ_MEASUREMENT EXPERIMENTS COMPLETE"
echo "=============================================="
...
echo "  - Data: OUTPUT/generated_data/ofat_varySM_*"
echo "  - Marformer: OUTPUT/IMPUTER/ofat_varySM_*_marformer"
echo "  - Stan (4c): OUTPUT/domain_model/runs/ofat_varySM_*_stan4c"
echo "  - Stan (4c) Eval: OUTPUT/domain_model/eval/ofat_varySM_*_stan4c_eval"
echo "  - Stan (1c): OUTPUT/domain_model/runs/ofat_varySM_*_stan1c"
echo "  - Stan (1c) Eval: OUTPUT/domain_model/eval/ofat_varySM_*_stan1c_eval"
echo "=============================================="
