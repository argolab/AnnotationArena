#!/bin/bash
# OFAT: Vary D (Embedding Dimension) Experiments Only
...
# Main execution
echo "=============================================="
echo "OFAT: VARY D (EMBEDDING DIMENSION) EXPERIMENTS"
echo "=============================================="
echo ""
...
echo "  D=$BASE_D (baseline, not run in this script)"
...
echo ""
echo "=============================================="
echo "OFAT VARY D EXPERIMENTS COMPLETE"
echo "=============================================="
...
echo "  - Data: OUTPUT/generated_data/ofat_varyD_*"
echo "  - Marformer: OUTPUT/IMPUTER/ofat_varyD_*_marformer"
echo "  - Stan (4c): OUTPUT/domain_model/runs/ofat_varyD_*_stan4c"
echo "  - Stan (4c) Eval: OUTPUT/domain_model/eval/ofat_varyD_*_stan4c_eval"
echo "  - Stan (1c): OUTPUT/domain_model/runs/ofat_varyD_*_stan1c"
echo "  - Stan (1c) Eval: OUTPUT/domain_model/eval/ofat_varyD_*_stan1c_eval"
echo "=============================================="
