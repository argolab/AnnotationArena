/*
 * Tensor model HMC inference with fixed hyperparameters.
 *
 * This file is intentionally identical to tensor_model.stan except that:
 *   sigma_u, sigma_v, sigma_uit, sigma_measurement, and kappa
 * are provided as data rather than inferred as parameters.
 *
