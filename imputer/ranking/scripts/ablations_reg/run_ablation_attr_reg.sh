...
# ── Ablation 3: ATTRIBUTE L2 REG ─────────────────────────────────────────────
# Base + L2 regularization on attribute deviation table only (1e-3).
# Attributes are a closed set of 9 — tests whether their deviations overfit.
...
RUN_NAME="ablation3_attrreg_${NUM_LAYERS}L${ATTENTION_HEADS}H_emb${EMBEDDING_DIM}_ffn${NUM_FFN_LAYERS}_${EPOCHS}ep"
...
echo ""
echo "============================================================"
echo " Ablation 3: ATTRIBUTE L2 REG = ${ATTRIBUTE_REG_WEIGHT}"
