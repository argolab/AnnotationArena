...
# ── Ablation 3: DEVIATION NORM ────────────────────────────────────────────────
# Base + LayerNorm applied to each deviation before adding to its type centroid.
# Bounds the deviation's contribution in feature space regardless of parameter magnitude.
...
RUN_NAME="ablation3_devnorm_${NUM_LAYERS}L${ATTENTION_HEADS}H_emb${EMBEDDING_DIM}_ffn${NUM_FFN_LAYERS}_${EPOCHS}ep"
...
echo ""
echo "============================================================"
echo " Ablation 3: DEVIATION NORM"
