...
# ── Ablation 3: BOTH ITEM + ATTRIBUTE L2 REG ─────────────────────────────────
# Base + L2 regularization on both item (1e-3) and attribute (1e-3) deviations.
# The strongest regularization condition short of removing deviations entirely.
...
RUN_NAME="ablation3_bothreg_${NUM_LAYERS}L${ATTENTION_HEADS}H_emb${EMBEDDING_DIM}_ffn${NUM_FFN_LAYERS}_${EPOCHS}ep"
...
echo ""
echo "============================================================"
echo " Ablation 3: BOTH ITEM + ATTR REG = ${ITEM_REG_WEIGHT} / ${ATTRIBUTE_REG_WEIGHT}"
