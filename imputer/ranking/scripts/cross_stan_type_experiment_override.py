...
Usage:
    PYTHONPATH=. python scripts/cross_stan_type_experiment_override.py
    PYTHONPATH=. python scripts/cross_stan_type_experiment_override.py --quick
    PYTHONPATH=. python scripts/cross_stan_type_experiment_override.py --output-base OUTPUT/cross_stan_experiment --quick
"""
