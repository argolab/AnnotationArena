...
# ── Ablation 4: BOTH ITEM + ATTRIBUTE L2 REG ─────────────────────────────────
# Replication of the ablation3 winner. Item (1e-3) + Attr (1e-3), no annot reg.
# Confirms the result holds as baseline for the new comparisons.
...
RUN_NAME="ablation4_bothreg_${NUM_LAYERS}L${ATTENTION_HEADS}H_emb${EMBEDDING_DIM}_ffn${NUM_FFN_LAYERS}_${EPOCHS}ep"
...
echo ""
echo "============================================================"
echo " Ablation 4: BOTH ITEM + ATTR REG = ${ITEM_REG_WEIGHT} / ${ATTRIBUTE_REG_WEIGHT}"
