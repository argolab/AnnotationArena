...
# Anchor for the ablations_reg_2 set.
...
RUN_NAME="ablation4_base_${NUM_LAYERS}L${ATTENTION_HEADS}H_emb${EMBEDDING_DIM}_ffn${NUM_FFN_LAYERS}_${EPOCHS}ep"
