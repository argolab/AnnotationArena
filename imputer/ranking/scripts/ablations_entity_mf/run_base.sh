...
# ── Ablation: BASE CASE ───────────────────────────────────────────────────────
# All architecture flags on. Soft LLM distribution input. Human rate = 0.
...
RUN_NAME="ablation_base_${NUM_LAYERS}L${ATTENTION_HEADS}H_emb${EMBEDDING_DIM}_ff${D_FF}_${EPOCHS}ep"
