...
#SBATCH --job-name=EntityMF_NoPerhead
#SBATCH --nodes=1
...
# ── Ablation: NO PER-HEAD RELATIONAL ATTENTION ────────────────────────────────
# Reverts to old shared-bias design: single R-dim relational bias shared across
# all heads identically. Everything else identical to base case.
...
# ── Architecture flags ────────────────────────────────────────────────────────
USE_PER_HEAD_REL=false    # <-- ablated: shared-bias design
USE_POINTER=true
USE_REL_VALUE=true
...
RUN_NAME="ablation_noperhead_${NUM_LAYERS}L${ATTENTION_HEADS}H_emb${EMBEDDING_DIM}_ff${D_FF}_${EPOCHS}ep"
...
echo ""
echo "============================================================"
echo " Ablation: NO PER-HEAD RELATIONAL ATTENTION"
echo "  bundle:       $BUNDLE"
