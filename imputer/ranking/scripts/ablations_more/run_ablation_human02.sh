...
# ── Ablation 2: HUMAN OBSERVED RATE = 0.2 ────────────────────────────────────
# Base: 0.0. Adds 20% human-observed training signal alongside LLM annotations.
...
LLM_ANNOTATOR_ID=24
HUMAN_OBSERVED_RATE=0.2          # <-- ablated: 0.2 (base = 0.0)
MAX_ITEM=10
...
RUN_NAME="ablation_human02_${NUM_LAYERS}L${ATTENTION_HEADS}H_emb${EMBEDDING_DIM}_ff${D_FF}_ffn${NUM_FFN_LAYERS}_${EPOCHS}ep"
...
RUN_NAME="${RUN_NAME}_human${HUMAN_OBSERVED_RATE}_${FLAGS}_${BUNDLE}"

echo ""
echo "============================================================"
echo " Ablation 2: HUMAN OBSERVED RATE = 0.2"
echo "  bundle:       $BUNDLE"
