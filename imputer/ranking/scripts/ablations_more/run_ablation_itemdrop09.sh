...
# ── Ablation 2: ITEM DROPOUT = 0.9 ───────────────────────────────────────────
# Base: 0.7. Higher dropout — stronger regularization, closer to fully inductive.
...
NUM_FFN_LAYERS=1
DROPOUT=0.1
ITEM_DROPOUT_RATE=0.9            # <-- ablated: 0.9 (base = 0.7)
...
RUN_NAME="ablation_drop09_${NUM_LAYERS}L${ATTENTION_HEADS}H_emb${EMBEDDING_DIM}_ff${D_FF}_ffn${NUM_FFN_LAYERS}_${EPOCHS}ep"
...
echo ""
echo "============================================================"
echo " Ablation 2: ITEM DROPOUT = 0.9"
echo "  bundle:       $BUNDLE"
