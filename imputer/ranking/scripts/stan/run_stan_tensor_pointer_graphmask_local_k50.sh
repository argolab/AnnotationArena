DATA_DIR="OUTPUT/generated_data/K_train_50_K_test_25_I_9_J_25_tensor"
...
# ── Run name base ─────────────────────────────────────────────────────────────
EXP_LABEL="ef1_pointer_graphmask_stan_k50_tensor"
...
echo ""
echo "============================================================"
echo " Stan Tensor (K=50): EF1 + Pointer + Graph Mask (1 run)"
