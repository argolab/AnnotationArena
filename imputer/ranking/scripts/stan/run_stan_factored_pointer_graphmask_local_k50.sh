DATA_DIR="OUTPUT/generated_data/K_train_50_K_test_25_I_9_J_25_factored_dot_product"
...
# ── Run name base ─────────────────────────────────────────────────────────────
EXP_LABEL="ef1_pointer_graphmask_stan_k50_factored"
...
echo ""
echo "============================================================"
echo " Stan Factored (K=50): EF1 + Pointer + Graph Mask (1 run)"
