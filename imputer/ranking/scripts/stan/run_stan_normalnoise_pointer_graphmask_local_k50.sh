DATA_DIR="OUTPUT/generated_data/K_train_50_K_test_25_I_9_J_25_normal_noise_dot_product"
...
# ── Run name base ─────────────────────────────────────────────────────────────
EXP_LABEL="ef1_pointer_graphmask_stan_k50_normal"
...
echo ""
echo "============================================================"
echo " Stan Normal Noise (K=50): EF1 + Pointer + Graph Mask (1 run)"
