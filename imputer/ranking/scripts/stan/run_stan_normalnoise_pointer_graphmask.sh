...
# ── Stan Synthetic: Normal Noise Dot-Product + Pointer + Graph Mask ───────────
# Same as run_stan_normalnoise_pointer.sh but with --use-graph-mask.
...
echo ""
echo "============================================================"
echo " Stan Normal Noise: EF1 + Pointer + Graph Mask (1 run)"
