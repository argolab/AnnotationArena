#!/bin/bash
# Resume UNIQUE12 sweep runs (group 2/3) from 600 -> 800 epochs on GPU 1.
#
#   cd imputer/ranking && export PYTHONPATH=.
#   CUDA_VISIBLE_DEVICES=1 bash scripts/DOMAIN3-FINAL/RecurrentMarformer/ItemExpansion/resume_unique12_group2_gpu1.sh
...
echo "============================================================"
echo " UNIQUE12 resume group 2/3 | GPU ${CUDA_VISIBLE_DEVICES:-1}"
