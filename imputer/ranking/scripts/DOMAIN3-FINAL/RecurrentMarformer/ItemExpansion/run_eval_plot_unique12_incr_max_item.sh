#!/bin/bash
# DOMAIN3-OLD-UNIQUE12_INCR_MAX_ITEM: resumed 600 -> 800, max_item=200.
#
# From ~/AA_new/imputer/ranking:
#   export PYTHONPATH=.
#   bash scripts/DOMAIN3-FINAL/RecurrentMarformer/ItemExpansion/run_eval_plot_unique12_incr_max_item.sh
...
export PHASE_NOTE="${PHASE_NOTE:-max_item=200 (epochs >600)}"
