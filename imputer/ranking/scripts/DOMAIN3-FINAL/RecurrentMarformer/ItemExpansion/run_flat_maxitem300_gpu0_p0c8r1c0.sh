#!/bin/bash
# Train p0c8r1c0 (0,8,1,0) — max_item=300, 1000 epochs.
#
# From ~/AA_new/imputer/ranking:
#   export PYTHONPATH=.
#   bash scripts/DOMAIN3-FINAL/RecurrentMarformer/ItemExpansion/run_flat_maxitem300_gpu0_p0c8r1c0.sh
...
export RUN_TAG="p0c8r1c0"
export PRELUDE_DEPTH=0
export NUM_CORE_LAYERS=8
export NUM_RECURRENCE=1
export CODA_DEPTH=0

echo "============================================================"
echo " Flat MAXITEM300 | ${RUN_TAG} (0,8,1,0) -> ${EPOCHS} epochs"
