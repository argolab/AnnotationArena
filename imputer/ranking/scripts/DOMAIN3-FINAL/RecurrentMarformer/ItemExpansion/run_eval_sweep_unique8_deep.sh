#!/bin/bash
# Evaluate all runs under DOMAIN3-OLD-UNIQUE8-DEEP (8 unique blocks, actual depth > 8).

set -euo pipefail
export PYTHONPATH=.
export PYTHONUNBUFFERED=1

RESULTS_ROOT="${RESULTS_ROOT:-RESULTS/RECURRENT_MARFORMER/DOMAIN3-OLD-UNIQUE8-DEEP}"
