...
EASY_PREFIX="easy_axis_smoke_test"
...
run_axis_mode "constant" 1 1 1 || ((FAILED_EXPERIMENTS += 1))
((TOTAL_EXPERIMENTS += 1))

# Single-axis modes
run_axis_mode "I_only" 0 1 1 || ((FAILED_EXPERIMENTS += 1))
((TOTAL_EXPERIMENTS += 1))

run_axis_mode "J_only" 1 0 1 || ((FAILED_EXPERIMENTS += 1))
((TOTAL_EXPERIMENTS += 1))

run_axis_mode "K_only" 1 1 0 || ((FAILED_EXPERIMENTS += 1))
((TOTAL_EXPERIMENTS += 1))

# Two-axis modes
run_axis_mode "IJ" 0 0 1 || ((FAILED_EXPERIMENTS += 1))
((TOTAL_EXPERIMENTS += 1))

run_axis_mode "IK" 0 1 0 || ((FAILED_EXPERIMENTS += 1))
((TOTAL_EXPERIMENTS += 1))

run_axis_mode "JK" 1 0 0 || ((FAILED_EXPERIMENTS += 1))
((TOTAL_EXPERIMENTS += 1))

# Full IJK dependence (reference)
run_axis_mode "IJK" 0 0 0 || ((FAILED_EXPERIMENTS += 1))
((TOTAL_EXPERIMENTS += 1))
