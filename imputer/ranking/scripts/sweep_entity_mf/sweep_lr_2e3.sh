...
#SBATCH --job-name=EMF_Sweep_LR2e3
#SBATCH --nodes=1
...
# ── Sweep: LEARNING RATE = 2e-3 (No Per-Head Rel base) ───────────────────────
# Base: 2e-4. Higher LR — faster early learning but may overshoot or diverge.
