...
#SBATCH --job-name=EMF_Sweep_LR2e5
#SBATCH --nodes=1
...
# ── Sweep: LEARNING RATE = 2e-5 (No Per-Head Rel base) ───────────────────────
# Base: 2e-4. Lower LR — slower, more stable convergence; may need more epochs.
