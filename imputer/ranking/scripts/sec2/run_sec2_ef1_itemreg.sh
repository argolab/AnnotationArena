...
# ── Section 2: EF1 (Pointer) + Item Regularization ───────────────────────────
# EF1 = pointer-enabled base (shared-bias + scale, item_dropout=0.7).
# Adds item L2 regularization (1e-3) on item deviation embeddings.
...
echo ""
echo "============================================================"
echo " Sec 2: EF1 + Item Reg (3 runs)"
