...
# ── Section 2: EF1 (Pointer) + Item Reg + Deviation Norm ─────────────────────
# EF1 = pointer-enabled base (shared-bias + scale, item_dropout=0.7).
# Adds both item L2 regularization (1e-3) and deviation norm.
...
echo ""
echo "============================================================"
echo " Sec 2: EF1 + Item Reg + Deviation Norm (3 runs)"
