...
# ── Section 2: EF1 (Pointer) + Deviation Norm ────────────────────────────────
# EF1 = pointer-enabled base (shared-bias + scale, item_dropout=0.7).
# Adds --use-deviation-norm: LayerNorm applied to each entity deviation before
# adding to its type centroid, bounding deviation scale.
...
echo ""
echo "============================================================"
echo " Sec 2: EF1 + Deviation Norm (3 runs)"
