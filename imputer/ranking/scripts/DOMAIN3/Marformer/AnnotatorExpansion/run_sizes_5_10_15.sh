...
OUTPUT_ROOT="RESULTS/MARFORMER/DOMAIN3/ANNOT_NEW"
...
echo ""
echo "============================================================"
echo " DOMAIN3 batch | Marformer | AnnotatorExpansion | run_sizes_5_10_15.sh"
...
for SIZE in "${SIZE_LIST[@]}"; do
    ...
    RUN_NAME="Tensor_400_25_9_DOMAIN3_Annot_T_${SIZE}_MARFORMER"
    ...
    echo ""
    echo "============================================================"
    echo " DOMAIN3 | Transductive | Annotator Expansion | Size ${SIZE}"
