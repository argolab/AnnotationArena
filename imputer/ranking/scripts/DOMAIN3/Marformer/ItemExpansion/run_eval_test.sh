...
RESULTS_ROOT="RESULTS/MARFORMER-NT/STAN/DOMAIN3/ITEM"
RUN_GLOB="Tensor_400_25_9_DOMAIN3_Item_NT_*_MARFORMER"

echo ""
echo "============================================================"
echo " DOMAIN3 ItemSplit — Test Evaluation (all checkpoints)"
echo "============================================================"
