...
echo ""
echo "============================================================"
echo " DOMAIN3 batch | Marformer | ItemExpansion | run_sizes_50_100_150.sh"
...
for SIZE in "${SIZE_LIST[@]}"; do
    ...
    RUN_NAME="Tensor_400_25_9_DOMAIN3_Item_T_${SIZE}_MARFORMER"
    ...
    echo ""
    echo "============================================================"
    echo " DOMAIN3 | Transductive | Item Expansion | Size ${SIZE}"
