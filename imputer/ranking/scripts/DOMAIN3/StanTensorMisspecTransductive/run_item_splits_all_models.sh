...
# Run all DOMAIN3 item-split transductive tensor misspecified models.
set -euo pipefail
...
OUTPUT_DIR="RESULTS/STAN/TENSOR/DOMAIN3_MISSPEC/ITEM"
SIZE_LIST=(50 100 150 200 250 300 350 400)
...
echo "============================================================"
echo " DOMAIN3 transductive item splits | tensor misspecified batch"
...
for SIZE in "${SIZE_LIST[@]}"; do
  ...
  for MODEL_ENTRY in "${MODELS[@]}"; do
    ...
    RUN_NAME="Tensor_400_25_9_DOMAIN3_Item_T_${SIZE}_${MODEL_TAG}"
