...
echo ""
echo "============================================================"
echo " DOMAIN3 batch | MarformerNT | ItemExpansion | run_sizes_50_100_150.sh"
echo " Sizes        : ${SIZE_LIST[*]}"
echo " Output root  : ${OUTPUT_ROOT:-$OUTPUT_DIR}"
echo "============================================================"

for SIZE in "${SIZE_LIST[@]}"; do
    DATA_DIR="DATA/STAN/DOMAIN3/ItemSplits/NonTransductive/Tensor_400_25_9_DOMAIN3_Item_NT_${SIZE}"
    RUN_NAME="Tensor_400_25_9_DOMAIN3_Item_NT_${SIZE}_MARFORMER"
    ...
    echo ""
    echo "============================================================"
    echo " DOMAIN3 | Non-Transductive | Item Expansion | Size ${SIZE}"
