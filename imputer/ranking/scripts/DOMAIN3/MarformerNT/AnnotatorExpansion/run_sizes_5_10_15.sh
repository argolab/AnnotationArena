...
OUTPUT_ROOT="RESULTS/MARFORMER-NT/STAN/DOMAIN3"
...
echo ""
echo "============================================================"
echo " DOMAIN3 batch | MarformerNT | AnnotatorExpansion | run_sizes_5_10_15.sh"
echo " Sizes        : ${SIZE_LIST[*]}"
echo " Output root  : ${OUTPUT_ROOT:-$OUTPUT_DIR}"
echo "============================================================"

for SIZE in "${SIZE_LIST[@]}"; do
    DATA_DIR="DATA/STAN/DOMAIN3/AnnotSplits/NonTransductive/Tensor_400_25_9_DOMAIN3_Annot_NT_${SIZE}"
    RUN_NAME="Tensor_400_25_9_DOMAIN3_Annot_NT_${SIZE}_MARFORMER"
    ...
    echo ""
    echo "============================================================"
    echo " DOMAIN3 | Non-Transductive | Annotator Expansion | Size ${SIZE}"
    echo "  MASKING_RATE : ${MASKING_RATE}"
    echo "  ITEM_DROPOUT : ${ITEM_DROPOUT_RATE}"
    echo "  ANNOT_DROPOUT: ${ANNOTATOR_DROPOUT_RATE}"
    echo "  ANNOT_REG    : ${ANNOTATOR_REG_WEIGHT}"
    echo "  EPOCHS       : ${EPOCHS}"
    echo "  DEVICE       : ${DEVICE}"
    echo "============================================================"
