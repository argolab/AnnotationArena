...
echo ""
echo "============================================================"
echo " DOMAIN3 batch | StanMisspecified | AnnotatorExpansion | run_sizes_5_10_15.sh"
...
for SIZE in "${SIZE_LIST[@]}"; do
    ...
    RUN_NAME="Tensor_400_25_9_DOMAIN3_Annot_T_${SIZE}_DISCRETE_MISP_DD"
    ...
    echo ""
    echo "============================================================"
    echo " Stan Discrete Misspecified | DOMAIN3 | Annotator Expansion | Size ${SIZE}"
    echo "  CHAINS       : ${CHAINS}"
