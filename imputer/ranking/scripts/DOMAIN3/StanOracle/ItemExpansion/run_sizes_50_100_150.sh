...
echo ""
echo "============================================================"
echo " DOMAIN3 batch | StanOracle | ItemExpansion | run_sizes_50_100_150.sh"
...
for SIZE in "${SIZE_LIST[@]}"; do
    ...
    RUN_NAME="Tensor_400_25_9_DOMAIN3_Item_T_${SIZE}_TENSOR"
    ...
    echo ""
    echo "============================================================"
    echo " Stan Tensor | DOMAIN3 | Item Expansion | Size ${SIZE}"
    echo "  CHAINS       : ${CHAINS}"
