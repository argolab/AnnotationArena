#!/bin/bash
# OFAT: Vary masking rate Experiments
...
run_experiment() {
    ...
    local mr_str=$(echo $masking_rate | sed 's/\.//g')

    # Construct run name with unique prefix
    local run_name="${OFAT_PREFIX}_varyMaskingRate_D${d_str}_sa${sa_str}_sm${sm_str}_kp${kp_str}_uc${uc_str}_mr${mr_str}_${BASE_PROTOCOL_CODE}"
...
# Main execution
echo "=============================================="
echo "OFAT: VARY MASKING RATE EXPERIMENTS"
echo "=============================================="
echo ""
...
echo "  Vary masking_rate: 5 (0.05, 0.15, 0.25, 0.50, 1.00)"
echo ""
...
# ===== OFAT: Vary masking rate =====
echo "======================================"
echo "OFAT SET: Varying masking rate"
echo "======================================"
for MR in 0.05 0.15 0.25 0.50 1.00; do
    run_experiment $MR
    if [ $? -ne 0 ]; then
        ((FAILED_EXPERIMENTS++))
    fi
...
echo ""
echo "=============================================="
echo "OFAT VARY MASKING RATE EXPERIMENTS COMPLETE"
echo "=============================================="
...
echo "  - Data: OUTPUT/generated_data/${OFAT_PREFIX}_varyMaskingRate_*"
echo "  - Marformer: OUTPUT/IMPUTER/${OFAT_PREFIX}_varyMaskingRate_*"
echo "  - Stan (4c): OUTPUT/domain_model/runs/${OFAT_PREFIX}_varyMaskingRate_*_stan4c"
echo "  - Stan (4c) Eval: OUTPUT/domain_model/eval/${OFAT_PREFIX}_varyMaskingRate_*_stan4c_eval"
echo "  - Stan (1c): OUTPUT/domain_model/runs/${OFAT_PREFIX}_varyMaskingRate_*_stan1c"
echo "  - Stan (1c) Eval: OUTPUT/domain_model/eval/${OFAT_PREFIX}_varyMaskingRate_*_stan1c_eval"
echo "=============================================="
