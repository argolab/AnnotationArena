...
# ── Ablation: Base + pointer ──────────────────────────────────────────────────
# Adds K_aug obs-obs shared-identity pointer bias on top of ablation base.
...
RUN_NAME="ablation_pointer_${NUM_LAYERS}L${ATTENTION_HEADS}H_emb${EMBEDDING_DIM}_ffn${NUM_FFN_LAYERS}_${EPOCHS}ep"
...
RUN_NAME="${RUN_NAME}_sharedbias_relscale_ptr_softinput_${BUNDLE}"

echo ""
echo "============================================================"
echo " Ablation: Base + pointer"
