...
#SBATCH --job-name=CPM_SUMMEVAL_SummEval_1600_8_4_1000_NONTRANS
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SPLIT="SummEval_1600_8_4_1000"
DATA_DIR="DATA/SUMMEVAL/${SPLIT}"
DATA_BUNDLE="${DATA_DIR}/data_bundle.json"
OUTPUT_DIR="RESULTS/STAN/SUMMEVAL/CPM"
RUN_NAME="SummEval_1600_8_4_1000_NONTRANS"
...
echo ""
echo "============================================================"
echo " SUMMEVAL | CPM Tensor | ${SPLIT}"
