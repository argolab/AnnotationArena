...
# Apache 2.0.
#
# Part B, single split: SummEval_1600_8_4_1000 only (see run_train_b.sh for all three).
#
...
#     /home/xwang397/bin/sbatch_adapt scripts/SUMMEVAL/MARFORMER/TRAIN/run_train_b_1000.sh
