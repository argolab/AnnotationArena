...
OUTPUT_ROOT="RESULTS/MARFORMER_HARD_MASK/SUMMEVAL"

# ── Splits to run (sequential, part A: small) ─────────────────────────────────
SPLITS=(
...
echo ""
echo "============================================================"
echo " SummEval | Marformer Hard Mask | Training — part A (splits 50/100/500)"
