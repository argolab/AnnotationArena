...
# Apache 2.0.
#
# LOCAL smoke-test: all SummEval splits, Marformer, 5 epochs.
# Usage: bash scripts/SUMMEVAL/LOCAL_TEST/run_local_test.sh
...
echo ""
echo "============================================================"
echo " [LOCAL TEST] SummEval | Marformer | ${EPOCHS} epochs — all splits"
