...
# Apache 2.0.
#
# LOCAL — train Marformer on LLMRubric_225_25_9_100 with HUMAN_OBSERVED_RATE=1.0.
# All human annotators are kept observed during training (oracle / upper-bound).
# Usage: bash scripts/LLM_RUBRIC/LOCAL_TEST/run_local_human_obs.sh
...
OUTPUT_ROOT="RESULTS/MARFORMER/LLM_RUBRIC_HUMAN_OBS"
SPLIT="LLMRubric_225_25_9_100"
...
echo ""
echo "============================================================"
echo " [LOCAL] LLM-Rubric | Marformer | ${SPLIT}"
echo "  HUMAN_OBSERVED_RATE : ${HUMAN_OBSERVED_RATE}  (all humans observed)"
...
echo ""
echo "============================================================"
echo " Done. Total time: $(( TOTAL_ELAPSED / 60 ))m $(( TOTAL_ELAPSED % 60 ))s"
