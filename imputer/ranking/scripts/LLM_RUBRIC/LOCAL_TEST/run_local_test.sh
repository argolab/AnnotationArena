...
# Apache 2.0.
#
# LOCAL smoke-test: all LLM-Rubric splits, Marformer, 5 epochs.
# Usage: bash scripts/LLM_RUBRIC/LOCAL_TEST/run_local_test.sh
...
echo ""
echo "============================================================"
echo " [LOCAL TEST] LLM-Rubric | Marformer | ${EPOCHS} epochs — all splits"
