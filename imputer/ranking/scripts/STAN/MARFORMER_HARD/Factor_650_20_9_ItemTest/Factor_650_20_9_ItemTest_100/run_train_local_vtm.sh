...
# ── Paths ─────────────────────────────────────────────────────────────────────
DATA_ROOT="DATA/STAN/Factor_650_20_9_ItemTest/Factor_650_20_9_ItemTest_100"
OUTPUT_ROOT="RESULTS/MARFORMER_HARD/STAN"
RUN_NAME="Factor_650_20_9_ItemTest_100_TRANSDUCTIVE_MASK05_DROP03_VTM"
...
USE_TRANSDUCTIVE_VALTEST_MASK=false
...
echo ""
echo "============================================================"
echo " STAN | Marformer Hard Transductive VTM | Factor_650_20_9_ItemTest_100"
echo "  MASKING_RATE     : ${MASKING_RATE}  (applied to val/test observed only)"
echo "  ITEM_DROPOUT     : ${ITEM_DROPOUT_RATE}"
echo "  ANNOTATOR_DROPOUT: ${ANNOTATOR_DROPOUT_RATE}"
echo "  USE_GRAPH_MASK   : ${USE_GRAPH_MASK}"
