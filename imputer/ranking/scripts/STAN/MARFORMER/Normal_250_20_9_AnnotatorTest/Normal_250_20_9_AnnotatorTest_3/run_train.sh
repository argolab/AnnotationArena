...
#     /home/xwang397/bin/sbatch_adapt scripts/STAN/MARFORMER/<family>/<split>/run_train.sh

_SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
_LEAF="$(basename "${_SCRIPT_DIR}")"
_PARENT="$(basename "$(dirname "${_SCRIPT_DIR}")")"
# .../scripts/STAN/MARFORMER/<parent>/<leaf>/run_train.sh → ranking root is 5 levels up.
...
echo ""
echo "============================================================"
echo " STAN | Marformer | ${_PARENT} / ${_LEAF}"
