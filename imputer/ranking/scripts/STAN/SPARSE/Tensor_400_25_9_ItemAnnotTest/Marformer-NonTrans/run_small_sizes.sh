...
echo ""
echo "============================================================"
echo " CLUSTER | Tensor_400_25_9_ItemAnnotTest | Sizes 10_5, 50_5, 100_10"
...
for SPEC in "10 5" "50 5" "100 10"; do
    read -r ITEMS ANNS <<< "$SPEC"
    DATA_ROOT="DATA/STAN/SPARSE/Tensor_400_25_9_ItemAnnotTest/Tensor_400_25_9_ItemAnnotTest_${ITEMS}_${ANNS}"
