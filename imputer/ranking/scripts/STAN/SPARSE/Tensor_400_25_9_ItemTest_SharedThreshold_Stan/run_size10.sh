...
SIZE=10
DATA_DIR="DATA/STAN/DOMAIN3-ITEM/Tensor_400_25_9_ItemTest_SharedThreshold_C4/Tensor_400_25_9_ItemTest_SharedThreshold_${SIZE}_C4"
DATA_BUNDLE="${DATA_DIR}/data_bundle.json"
OUTPUT_DIR="RESULTS/STAN/SPARSE"
RUN_NAME="Tensor_400_25_9_ItemTest_SharedThreshold_${SIZE}_C4"
...
echo ""
echo "============================================================"
echo " Stan Tensor | Tensor_400_25_9_ItemTest_${SIZE}"
echo "  CHAINS       : ${CHAINS}"
