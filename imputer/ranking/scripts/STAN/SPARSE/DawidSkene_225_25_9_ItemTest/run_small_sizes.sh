...
echo ""
echo "============================================================"
echo " CLUSTER | No Item Dev Transductive | Sizes 10, 30, 50, 75"
...
for SIZE in 10 30 50 75; do
    DATA_ROOT="DATA/STAN/SPARSE/DawidSkene_225_25_9_ItemTest/DawidSkene_225_25_9_ItemTest_${SIZE}"
