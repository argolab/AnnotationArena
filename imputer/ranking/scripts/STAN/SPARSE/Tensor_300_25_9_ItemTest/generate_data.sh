...
DATA_ROOT="DATA/STAN/SPARSE/Tensor_300_25_9_ItemTest"

echo ""
echo "============================================================"
echo " Step 1: Generate Tensor_300_25_9_ItemTest_200"
echo "  K_train=200  K_test=50  K_val=50  C=5  I=9  J=25"
echo "============================================================"

python STAN/stan_code/scripts/generate_data.py \
    --output-dir            "$DATA_ROOT"                       \
    --run-name              "Tensor_300_25_9_ItemTest_200"     \
    --stan-type             "tensor"                           \
    --K-train               200                                \
    --K-test                50                                 \
    --K-val                 50                                 \
...
for SIZE in 100 50 10 5; do
    echo ""
    echo "--- Subsetting K_train=${SIZE} ---"
    python STAN/stan_code/scripts/subset_item_split.py \
        --input-dir  "$DATA_ROOT/Tensor_300_25_9_ItemTest_200" \
        --output-dir "$DATA_ROOT/Tensor_300_25_9_ItemTest_${SIZE}" \
        --train-num  $SIZE
done
