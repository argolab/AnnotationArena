...
for SIZE in 10 50 100 200; do
    DATA_ROOT="DATA/STAN/SPARSE/Tensor_300_25_9_ItemTest/Tensor_300_25_9_ItemTest_${SIZE}"
    RUN_NAME="Tensor_300_25_9_ItemTest_${SIZE}_CLUSTER_NOITEMDEV_TRANS"
    RUN_START=$SECONDS
