...
SIZE=10
DATA_DIR="DATA/STAN/SPARSE/Tensor_300_25_9_ItemTest/Tensor_300_25_9_ItemTest_${SIZE}"
DATA_BUNDLE="${DATA_DIR}/data_bundle.json"
OUTPUT_DIR="RESULTS/STAN/SPARSE"
RUN_NAME="Tensor_300_25_9_ItemTest_${SIZE}_TEN"
...
echo ""
echo "============================================================"
echo " Stan Tensor | Tensor_300_25_9_ItemTest_${SIZE}"
echo "  CHAINS       : ${CHAINS}"
