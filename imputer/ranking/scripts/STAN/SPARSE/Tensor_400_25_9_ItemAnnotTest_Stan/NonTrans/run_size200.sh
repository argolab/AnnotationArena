...
#SBATCH --job-name=ITEMANN_200_STAN
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
RUN_NAME="Tensor_400_25_9_ItemAnnotTest_${ITEM_SIZE}_${ANN_SIZE}_NONTRANS"
...
echo ""
echo "============================================================"
echo " Stan Tensor | Tensor_400_25_9_ItemAnnotTest_${ITEM_SIZE}_${ANN_SIZE}"
echo "  CHAINS       : ${CHAINS}"
