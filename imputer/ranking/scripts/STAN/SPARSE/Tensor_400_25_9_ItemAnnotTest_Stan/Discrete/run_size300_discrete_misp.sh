...
#SBATCH --job-name=ITEMANN_300_DISC
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
ITEM_SIZE=300
ANN_SIZE=15
DATA_DIR="DATA/STAN/SPARSE/Tensor_400_25_9_ItemAnnotTest/Tensor_400_25_9_ItemAnnotTest_${ITEM_SIZE}_${ANN_SIZE}"
DATA_BUNDLE="${DATA_DIR}/data_bundle.json"
OUTPUT_DIR="RESULTS/STAN/SPARSE"
RUN_NAME="Tensor_400_25_9_ItemAnnotTest_${ITEM_SIZE}_${ANN_SIZE}_DISCRETE_MISP"
...
echo ""
echo "============================================================"
echo " Stan Discrete Misspecified | Tensor_400_25_9_ItemAnnotTest_${ITEM_SIZE}_${ANN_SIZE}"
echo "  CHAINS       : ${CHAINS}"
echo "  ITER_WARMUP  : ${ITER_WARMUP}"
echo "  ITER_SAMPLING: ${ITER_SAMPLING}"
echo "  (misspecified: M=6, S=6, sigma_measurement=1.0, temperature=1.0)"
echo "============================================================"
