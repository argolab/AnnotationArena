...
RUN_NAME="Factor_225_25_9_ItemTest_Size_175_TRANSDUCTIVE_015"
...
echo ""
echo "============================================================"
echo " STAN SPARSE | Marformer Transductive | Factor_225_25_9_ItemTest_Size_175"
