...
# Apache 2.0.
# Phase 1 — Versions B & C: non-transductive, item_dropout=0.7, 200 epochs

#SBATCH --job-name=EMF_SP_P1_vBC
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
RUN_NAME="Factor_225_25_9_ItemTest_Size_175_PHASE1_vBC"
...
echo ""
echo "============================================================"
echo " PHASE 1 vBC | Non-Transductive | item_dropout=0.7"
