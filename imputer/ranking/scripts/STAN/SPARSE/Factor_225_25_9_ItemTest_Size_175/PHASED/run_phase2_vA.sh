...
# Apache 2.0.
# Phase 2 — Version A: test-only fine-tune, item_dropout=0.0, 100 epochs
# Loads best checkpoint from Phase 1 vA (item_dropout=1.0)

#SBATCH --job-name=EMF_SP_P2_vA
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ── Phase 1 checkpoint ────────────────────────────────────────────────────────
PHASE1_RUN_DIR="RESULTS/MARFORMER/STAN/SPARSE/Factor_225_25_9_ItemTest_Size_175_PHASE1_vA"
...
RUN_NAME="Factor_225_25_9_ItemTest_Size_175_PHASE2_vA"
...
echo ""
echo "============================================================"
echo " PHASE 2 vA | Test-Only Fine-tune | item_dropout=0.0"
