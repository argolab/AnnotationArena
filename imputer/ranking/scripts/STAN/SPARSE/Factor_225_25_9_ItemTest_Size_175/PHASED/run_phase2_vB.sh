...
# Apache 2.0.
# Phase 2 — Version B: test-only fine-tune, item_dropout=0.7, 100 epochs
# Loads best checkpoint from Phase 1 vBC (item_dropout=0.7)

#SBATCH --job-name=EMF_SP_P2_vB
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
RUN_NAME="Factor_225_25_9_ItemTest_Size_175_PHASE2_vB"
...
echo ""
echo "============================================================"
echo " PHASE 2 vB | Test-Only Fine-tune | item_dropout=0.7"
