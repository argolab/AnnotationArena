...
# Apache 2.0.
# Local debug run — NON-transductive, CPU, 3 epochs
...
RUN_NAME="Factor_225_25_9_ItemTest_Size_175_LOCAL_NONTRANSDUCTIVE"
...
echo ""
echo "============================================================"
echo " LOCAL | Marformer NON-TRANSDUCTIVE | Factor_225_25_9_ItemTest_Size_175"
