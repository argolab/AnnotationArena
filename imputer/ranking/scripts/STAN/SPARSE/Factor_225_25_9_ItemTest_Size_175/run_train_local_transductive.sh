...
# Apache 2.0.
# Local debug run — transductive learning, CPU, 3 epochs
...
RUN_NAME="Factor_225_25_9_ItemTest_Size_175_LOCAL_TRANSDUCTIVE"
...
echo ""
echo "============================================================"
echo " LOCAL | Marformer TRANSDUCTIVE | Factor_225_25_9_ItemTest_Size_175"
