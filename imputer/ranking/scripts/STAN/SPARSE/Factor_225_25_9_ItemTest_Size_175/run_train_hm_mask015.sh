...
#SBATCH --job-name=EMF_SP_F_HM_015
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
RUN_NAME="Factor_225_25_9_ItemTest_Size_175_TRANSDUCTIVE_HM_015"
...
echo ""
echo "============================================================"
echo " STAN SPARSE | Marformer Hard Mask Transductive | Factor_225_25_9_ItemTest_Size_175"
