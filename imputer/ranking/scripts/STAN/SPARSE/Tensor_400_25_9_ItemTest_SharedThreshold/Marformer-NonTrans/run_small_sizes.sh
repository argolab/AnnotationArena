...
echo ""
echo "============================================================"
echo " CLUSTER | No Item Dev Transductive | Sizes 10, 50, 100"
...
for SIZE in 10 50 100; do
    DATA_ROOT="DATA/STAN/DOMAIN3-ITEM/Tensor_400_25_9_ItemTest_SharedThreshold_C4/Tensor_400_25_9_ItemTest_SharedThreshold_${SIZE}_C4"
    RUN_NAME="Tensor_400_25_9_ItemTest_SharedThreshold_${SIZE}_C4_NOITEMDEV_NONTRANS_MARFORMER"
    RUN_START=$SECONDS
