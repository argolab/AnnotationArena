...
#SBATCH --job-name=EMF_STAN_T_03_D07
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo ""
echo "============================================================"
echo " CLUSTER | No Item Dev Transductive | Sizes 10, 20, 30, 50"
...
for SIZE in 10 20 30 50; do
    DATA_ROOT="DATA/STAN/SPARSE/Factor_225_25_9_ItemTest/Factor_225_25_9_ItemTest_${SIZE}"
    RUN_NAME="Factor_225_25_9_ItemTest_${SIZE}_CLUSTER_NOITEMDEV_TRANS"
    RUN_START=$SECONDS
