...
#SBATCH --job-name=EMF_SP_N_HM_035
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ── Paths ─────────────────────────────────────────────────────────────────────
DATA_ROOT="DATA/STAN/SPARSE/Normal_225_25_9_ItemTest/Normal_225_25_9_ItemTest_Size_175"
OUTPUT_ROOT="RESULTS/MARFORMER_HARD_MASK/STAN/SPARSE"
RUN_NAME="Normal_225_25_9_ItemTest_Size_175_TRANSDUCTIVE_HM_035"
...
echo ""
echo "============================================================"
echo " STAN SPARSE | Marformer Hard Mask Transductive | Normal_225_25_9_ItemTest_Size_175"
