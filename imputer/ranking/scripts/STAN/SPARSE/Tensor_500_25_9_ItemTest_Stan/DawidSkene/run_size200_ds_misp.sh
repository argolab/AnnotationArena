...
RUN_NAME="Tensor_500_25_9_ItemTest_${SIZE}_DS_MISP"
...
echo ""
echo "============================================================"
echo " Stan Dawid-Skene Misspecified | Tensor_500_25_9_ItemTest_${SIZE}"
echo "  CHAINS       : ${CHAINS}"
echo "  ITER_WARMUP  : ${ITER_WARMUP}"
echo "  ITER_SAMPLING: ${ITER_SAMPLING}"
echo "  (misspecified: D=16, d_annotator=32, kappa=2.0, sigma_measurement=0.5, sigma_annotator=0.6, alpha_confusion=30.0)"
echo "============================================================"

echo "[1/2] Running MCMC (dawid-skene, misspecified)..."
