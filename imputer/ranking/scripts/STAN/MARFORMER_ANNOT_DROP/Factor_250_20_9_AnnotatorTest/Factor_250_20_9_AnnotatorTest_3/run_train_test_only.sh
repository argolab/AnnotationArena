...
RUN_NAME="Factor_250_20_9_AnnotatorTest_3_TRAIN_ONLY_MASK05"
...
echo ""
echo "============================================================"
echo " STAN | Marformer Train-Only Transductive | Factor_250_20_9_AnnotatorTest_3"
echo "  MASKING_RATE     : ${MASKING_RATE}  (applied to train_observed only)"
