...
#SBATCH --job-name=EMF_STAN_T_05_D07
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
RUN_NAME="Normal_250_20_9_AnnotatorTest_9_TRANSDUCTIVE_MASK05_DROP07"
...
# ── Experiment-specific flags (swap item vs annotator dropout vs default MARFORMER) ─
...
echo ""
echo "============================================================"
echo " STAN | Marformer Transductive | Normal_250_20_9_AnnotatorTest_9"
