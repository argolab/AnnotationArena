...
#SBATCH --job-name=EMF_STAN_HM_T_05_D07
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ── Paths ─────────────────────────────────────────────────────────────────────
DATA_ROOT="DATA/STAN/Normal_250_20_9_AnnotatorTest/Normal_250_20_9_AnnotatorTest_3"
OUTPUT_ROOT="RESULTS/MARFORMER_HARD_MASK/STAN"
RUN_NAME="Normal_250_20_9_AnnotatorTest_3_TRANSDUCTIVE_MASK05_DROP07_HM"
...
echo ""
echo "============================================================"
echo " STAN | Marformer Hard Mask Transductive | Normal_250_20_9_AnnotatorTest_3"
