...
# ── Exp 01: + K_aug Pointer ───────────────────────────────────────────────────
# Base + K_aug obs-obs shared-identity pointer bias. Item dropout 0.7.
...
echo ""
echo "============================================================"
echo " Final Ablation Exp 01: + K_aug Pointer (3 runs)"
