...
# ── Exp 03: Per-Head Relational Bias ─────────────────────────────────────────
# Replaces shared-bias with per-head relational bias. scale-shared-rel is not
# applicable here (per-head mode has its own joint scaling). Item dropout 0.7.
...
USE_PER_HEAD_REL=true       # per-head: no --no-per-head-rel, no --scale-shared-rel
SCALE_SHARED_REL=false      # not applicable in per-head mode
USE_POINTER=false
USE_REL_VALUE=false
...
echo ""
echo "============================================================"
echo " Final Ablation Exp 03: Per-Head Relational Bias (3 runs)"
...
echo "  note: per-head mode — no shared-bias, no scale-shared-rel"
echo "============================================================"
