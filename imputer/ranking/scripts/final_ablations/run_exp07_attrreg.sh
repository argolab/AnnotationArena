...
# ── Exp 07: + Attribute L2 Regularization Only ───────────────────────────────
# Base + attr_reg=1e-3. Item reg remains 0. Item dropout 0.7.
...
echo ""
echo "============================================================"
echo " Final Ablation Exp 07: + Attr L2 Reg Only (3 runs)"
