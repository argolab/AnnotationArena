...
#SBATCH --job-name=EMF_FA_DevNorm
#SBATCH --nodes=1
...
# ── Exp 09: + Deviation Norm ──────────────────────────────────────────────────
# Base + LayerNorm applied to each deviation before adding to type centroid.
# No regularization. Item dropout 0.7.
...
echo ""
echo "============================================================"
echo " Final Ablation Exp 09: + Deviation Norm (3 runs)"
