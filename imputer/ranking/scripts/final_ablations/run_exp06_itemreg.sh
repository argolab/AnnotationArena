...
# ── Exp 06: + Item L2 Regularization Only ────────────────────────────────────
# Base + item_reg=1e-3. Attr reg remains 0. Item dropout 0.7.
...
echo ""
echo "============================================================"
echo " Final Ablation Exp 06: + Item L2 Reg Only (3 runs)"
