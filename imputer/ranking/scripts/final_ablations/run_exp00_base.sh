...
# ── Exp 00: Base ──────────────────────────────────────────────────────────────
# Minimal model: shared-bias + correct scaling, standard softmax, no pointer,
# no rel-value, no regularization, no deviation norm, no item dropout.
# Serves as the clean lower-bound reference for all other experiments.
...
echo ""
echo "============================================================"
echo " Final Ablation Exp 00: Base (3 runs)"
