...
# ── Exp 10: All Together ──────────────────────────────────────────────────────
# Base + pointer + rel-value + add-one + item_reg + attr_reg + deviation norm.
# Shared-bias + correct scaling throughout (per-head-rel excluded, exp 03 only).
# Item dropout 0.7.
...
echo ""
echo "============================================================"
echo " Final Ablation Exp 10: All Together (3 runs)"
