...
# ── Exp 02: + Relational Value Augmentation ───────────────────────────────────
# Base + V_{ij} = V(x_j) + sum_r e_r * edge_mask[i,j,r]. Item dropout 0.7.
...
echo ""
echo "============================================================"
echo " Final Ablation Exp 02: + Relational Value Augmentation (3 runs)"
