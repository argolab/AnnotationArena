...
# ── Hyperparam search: higher item + attribute L2 reg (1e-2 vs base 1e-3) ────
...
ITEM_REG_WEIGHT=1e-2       # <-- ablated: 1e-2 vs base 1e-3
ATTRIBUTE_REG_WEIGHT=1e-2  # <-- ablated: 1e-2 vs base 1e-3
ANNOTATOR_REG_WEIGHT=0.0

RUN_NAME="multirun_highreg_${NUM_LAYERS}L${ATTENTION_HEADS}H_emb${EMBEDDING_DIM}_ffn${NUM_FFN_LAYERS}_${EPOCHS}ep"
...
echo ""
echo "============================================================"
echo " Hyperparam search: higher item + attr L2 reg (1e-2)"
