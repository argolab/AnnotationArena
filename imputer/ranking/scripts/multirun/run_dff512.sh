...
# ── Hyperparam search: D_FF = 512 (vs base 128) ──────────────────────────────
...
NUM_LAYERS=8
ATTENTION_HEADS=4
D_FF=512               # <-- ablated: 512 vs base 128
NUM_FFN_LAYERS=1
DROPOUT=0.1
...
RUN_NAME="multirun_dff512_${NUM_LAYERS}L${ATTENTION_HEADS}H_emb${EMBEDDING_DIM}_dff${D_FF}_ffn${NUM_FFN_LAYERS}_${EPOCHS}ep"
...
echo ""
echo "============================================================"
echo " Hyperparam search: D_FF=512"
