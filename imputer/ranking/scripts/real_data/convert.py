...
# ============================================================================
HUMAN_TSV   = "/path/to/human_judges_real_convs_FIXED_ANON.tsv"
LLM_TSV     = "/path/to/gpt-3_5-turbo-16k_real_evaluations_FIXED.tsv"
OUTPUT_PATH = "/path/to/data_bundle.json"
