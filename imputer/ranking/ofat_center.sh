#!/bin/bash
# OFAT: Center Baseline Experiment Only
...
# Main execution
echo "=============================================="
echo "OFAT: CENTER BASELINE EXPERIMENT"
echo "=============================================="
echo ""
...
echo ""
echo "=============================================="
echo "OFAT CENTER BASELINE EXPERIMENT COMPLETE"
echo "=============================================="
...
echo "  - Data: OUTPUT/generated_data/ofat_center_*"
echo "  - Marformer: OUTPUT/IMPUTER/ofat_center_*_marformer"
echo "  - Stan (4c): OUTPUT/domain_model/runs/ofat_center_*_stan4c"
echo "  - Stan (4c) Eval: OUTPUT/domain_model/eval/ofat_center_*_stan4c_eval"
echo "  - Stan (1c): OUTPUT/domain_model/runs/ofat_center_*_stan1c"
echo "  - Stan (1c) Eval: OUTPUT/domain_model/eval/ofat_center_*_stan1c_eval"
echo "=============================================="
