#!/bin/bash
# OFAT: Vary Protocol Experiments Only
...
# Main execution
echo "=============================================="
echo "OFAT: VARY PROTOCOL EXPERIMENTS"
echo "=============================================="
echo ""
...
echo "  κ=$BASE_KAPPA"
echo "  Protocol=$BASE_PROTOCOL (SMAR) (baseline, not run in this script)"
...
# ===== OFAT: Vary Protocol =====
echo "======================================"
echo "OFAT SET: Varying Protocol"
echo "======================================"
...
echo ""
echo "=============================================="
echo "OFAT VARY PROTOCOL EXPERIMENTS COMPLETE"
echo "=============================================="
...
echo "  - Data: OUTPUT/generated_data/ofat_varyProtocol_*"
echo "  - Marformer: OUTPUT/IMPUTER/ofat_varyProtocol_*_marformer"
echo "  - Stan (4c): OUTPUT/domain_model/runs/ofat_varyProtocol_*_stan4c"
echo "  - Stan (4c) Eval: OUTPUT/domain_model/eval/ofat_varyProtocol_*_stan4c_eval"
echo "  - Stan (1c): OUTPUT/domain_model/runs/ofat_varyProtocol_*_stan1c"
echo "  - Stan (1c) Eval: OUTPUT/domain_model/eval/ofat_varyProtocol_*_stan1c_eval"
echo "=============================================="
