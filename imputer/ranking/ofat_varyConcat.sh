#!/bin/bash
# OFAT: Vary use_concat_embedding Experiments Only
...
echo "  use_concat_embedding=$BASE_USE_CONCAT (baseline, not run in this script)"
echo ""
...
echo "  - Data: OUTPUT/generated_data/ofat_varyConcat_*"
echo "  - Marformer: OUTPUT/IMPUTER/ofat_varyConcat_*_marformer"
echo "  - Stan (4c): OUTPUT/domain_model/runs/ofat_varyConcat_*_stan4c"
echo "  - Stan (4c) Eval: OUTPUT/domain_model/eval/ofat_varyConcat_*_stan4c_eval"
echo "  - Stan (1c): OUTPUT/domain_model/runs/ofat_varyConcat_*_stan1c"
echo "  - Stan (1c) Eval: OUTPUT/domain_model/eval/ofat_varyConcat_*_stan1c_eval"
echo "=============================================="
