...
def evaluate_entity_marformer_split(
    ...
    # Switch to eval mode so item dropout and nn.Dropout are disabled during
    # evaluation — gives a clean, deterministic signal. try/finally guarantees
    # training mode is always restored even if the forward pass raises.
