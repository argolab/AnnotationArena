...
# Variant: concat embedding + --use-random-as-key enabled, MARFORMER_FULL_RANDOM=1 (refresh each forward)
#
# Matches run_single_kp10.sh except:
# - BASE_USE_CONCAT=1
# - Adds --use-random-as-key
# - MARFORMER_FULL_RANDOM toggled (this file: 1)
...
MARFORMER_FULL_RANDOM=1         # 0 = disable refresh, 1 = enable refresh
...
RUN_NAME="marformer_kp10_concat_random_as_key_fresh"
