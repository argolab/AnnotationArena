#!/bin/bash
# OFAT: Vary σ_annotator Experiments Only
...
# Main execution
echo "=============================================="
echo "OFAT: VARY σ_ANNOTATOR EXPERIMENTS"
echo "=============================================="
echo ""
...
echo "  D=$BASE_D"
echo "  σ_annotator=$BASE_SIGMA_ANNOTATOR (baseline, not run in this script)"
...
echo "======================================"
echo "OFAT SET: Varying σ_annotator"
echo "======================================"
...
echo ""
echo "=============================================="
echo "OFAT VARY σ_ANNOTATOR EXPERIMENTS COMPLETE"
echo "=============================================="
...
echo "  - Data: OUTPUT/generated_data/ofat_varySA_*"
echo "  - Marformer: OUTPUT/IMPUTER/ofat_varySA_*_marformer"
echo "  - Stan (4c): OUTPUT/domain_model/runs/ofat_varySA_*_stan4c"
echo "  - Stan (4c) Eval: OUTPUT/domain_model/eval/ofat_varySA_*_stan4c_eval"
echo "  - Stan (1c): OUTPUT/domain_model/runs/ofat_varySA_*_stan1c"
echo "  - Stan (1c) Eval: OUTPUT/domain_model/eval/ofat_varySA_*_stan1c_eval"
echo "=============================================="
