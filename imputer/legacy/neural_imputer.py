"""
Neural imputer implementation for graph imputation.

This module contains the transformer-based neural imputer model architecture 
and training code for imputing missing values in graph data.
...
def evaluate_neural_model(model, test_data, n_nodes, n_states=2):
    ...
    print(f"Evaluating neural model on {len(test_data)} test samples...")
